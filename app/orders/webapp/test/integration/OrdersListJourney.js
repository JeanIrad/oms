...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheOrdersList.onTable().iCheckColumns(undefined, {"customer_ID":{"header":"Customer"},"createdAt":{"header":"Order Date"},"totalPrice":{"header":"Total Price"},"status":{"header":"Status"}});
