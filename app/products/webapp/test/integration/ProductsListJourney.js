...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheProductsList.onTable().iCheckColumns(undefined, {"imageUrl":{"header":"Image"},"name":{"header":"Product Name"},"category":{"header":"Category"},"price":{"header":"Price"},"stock":{"header":"Stock"}});
